    ...
    <div class="container mx-auto max-w-6xl relative z-10">
      ...
      <div class="grid md:grid-cols-3 gap-8 relative">
        <div v-for="feature in features" :key="feature.id" class="feature-card">
          ...
          >
            <!-- Content wrapper with zoom effect -->
            <div class="relative z-0 transition-transform duration-500 group-hover:scale-105">
            ...
            <!-- Blur overlay with centered button -->
            <div
              class="absolute inset-0 bg-white/50 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 z-10 rounded-2xl"
            >
              <button
                class="cursor-pointer pointer-events-auto py-4 px-8 rounded-lg text-white font-medium transition-all duration-300 transform scale-75 group-hover:scale-100 shadow-xl flex items-center justify-center"
                :class="feature.color.primary"
              >
            ...
            <div
              class="absolute inset-0 rounded-2xl ring-1 ring-gray-200 group-hover:ring-4 transition-all duration-500 z-0"
