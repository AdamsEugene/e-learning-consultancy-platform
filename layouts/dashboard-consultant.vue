<!-- layouts/dashboard-consultant.vue -->
...
// Navigation menu for consultant
const navItems = [
  { title: "Dashboard", path: "/dashboard/consultant", icon: "home" },
  { title: "Projects", path: "/dashboard/consultant/projects", icon: "briefcase" },
  {
    title: "Client Requests",
    path: "/dashboard/consultant/requests",
    icon: "inbox",
    badge: notificationCount,
  },
  { title: "Appointments", path: "/dashboard/consultant/appointments", icon: "calendar" },
  { title: "Time Tracking", path: "/dashboard/consultant/time-tracking", icon: "clock" },
  { title: "Invoices", path: "/dashboard/consultant/invoices", icon: "document-text" },
  { title: "Analytics", path: "/dashboard/consultant/analytics", icon: "chart-bar" },
  { title: "Resources", path: "/dashboard/consultant/resources", icon: "library" },
  { title: "Team", path: "/dashboard/consultant/team", icon: "users" },
  { title: "Messages", path: "/dashboard/consultant/messages", icon: "chat", badge: 3 },
  { title: "Settings", path: "/dashboard/consultant/settings", icon: "settings" },
  { title: "Help & Support", path: "/dashboard/consultant/support", icon: "help-circle" },
];
...
const quickActions = [
  {
    ...
    path: "/dashboard/consultant/projects/create",
    icon: "document-add",
    color: "bg-indigo-500",
  },
  {
    title: "Schedule Meeting",
    path: "/dashboard/consultant/appointments/schedule",
    icon: "calendar-add",
    color: "bg-green-500",
  },
  {
    title: "Create Invoice",
    path: "/dashboard/consultant/invoices/create",
    icon: "cash",
    color: "bg-amber-500",
  },
  {
    title: "Add Time Entry",
    path: "/dashboard/consultant/time-tracking/add",
    icon: "clock",
    color: "bg-purple-500",
  },
];
...
<template>
  <div class="flex h-screen bg-gray-50 overflow-hidden">
    ...
    >
      ...
      <!-- Consultant Stats Summary (only when expanded) -->
      <div
        v-if="isSidebarOpen"
      ...
      >
        <div class="flex items-center justify-between w-full px-4">
          ...
          <div class="flex items-center space-x-4">
            ...
            <!-- Create Proposal Button (visible on larger screens) -->
            <NuxtLink
              to="/dashboard/consultant/projects/create"
